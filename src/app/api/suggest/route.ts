...
${placesSection}
【条件】季節イベント1〜2個含む（${getSeasonalHints(month)}）、天気・予算・時間に合ったものだけ
  ...
  "suggestions": [
    {
      ...
      "category": "アウトドア/文化・芸術/食/スポーツ/リラックス/学び/季節イベント/ショッピング/観光",
      "estimatedTime": "所要時間",
      "estimatedCost": "費用",
      "isSeasonalEvent": true/false,
      "seasonalNote": "旬の理由（30文字以内、isSeasonalEventがtrueのみ）",
      "tips": "アドバイス（40文字以内）",
      "placeName": "施設名またはnull",
      "mapsSearchQuery": "Maps検索ワード"
    }
  ],
  "summary": "一言アドバイス（40文字以内）"
}`;
